(() => {
  ...
  const terminalLines = [
    ...
    { text: "", color: "text" },
    { text: "  ESTADO DEL SISTEMA                OmniMon v6.1.0", color: "cyan" },
    { text: "  -----------------------------------------", color: "text-dim" },
    { text: "  CPU     58.3% total  |  6 nucleos activos", color: "green" },
    { text: "  Memory  11.4 / 16 GB | vista agrupada por proceso", color: "amber" },
    { text: "  Alerts  alertas agrupadas + debounce de picos de salud", color: "text" },
    { text: "", color: "text" },
    { text: "  NOVEDADES", color: "cyan" },
    { text: "  -----------------------------------------", color: "text-dim" },
    { text: "  releases firmados  Ed25519 + SHA-256", color: "text" },
    { text: "  chat IA            streaming de tokens + 7 presets", color: "text" },
    { text: "  tool calling       procesos, red y seguridad", color: "text" },
    { text: "  observabilidad     iconos nativos + dashboards clickeables", color: "text" },
    { text: "", color: "text" },
    { text: "  OK integridad del release verificada | escudo activo", color: "green" }
  ];
